export default function Hero() {
  return (
    <section className="flex flex-col items-center gap-10 px-[120px] pt-20 pb-12 w-full">
      {/* Badge */}
      ...
      <div className="flex flex-col items-center gap-6">
        <h1 className="font-serif text-[56px] text-[var(--l-text-primary)] text-center leading-tight max-w-[900px]">
          Purpose-built runtime for
          <br />
          AI agent execution
        </h1>
        <p className="font-sans text-[17px] text-[var(--l-text-tertiary)] text-center leading-[1.6] max-w-[720px]">
      ...
      <div className="flex items-center gap-4">
        <a
          href="#"
          className="font-sans text-[15px] font-medium text-[var(--l-text-primary)] rounded-lg px-8 py-3.5 border border-[var(--l-border)] hover:bg-[var(--l-bg-subtle)] transition-colors"
        >
          See How It Works
        </a>
        <a
      ...
      {/* Hero Diagram */}
      <div className="flex items-center justify-center w-full max-w-[880px] py-6">
        {/* Box 1 - Agent Brain */}
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl bg-[var(--l-bg-subtle)] border border-[var(--l-border)] px-7 py-6 w-[230px]">
        ...
        {/* Box 2 - Saph Runtime */}
        <div className="flex flex-col items-center justify-center gap-3.5 rounded-xl bg-[var(--l-accent-light)] border-[1.5px] border-[var(--l-accent)] px-7 py-6 w-[260px]">
